...
public class BlackContactAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.mModeTV = (TextView) view.findViewById(R.id.tv_black_name);
...
holder=(ViewHolder) view.getTag();
        ...
        holder.mNameTV.setTextColor(context.getResources().getColor(R.color.bright_purplr));
        holder.mModeTV.setTextColor(context.getResources().getColor(R.color.bright_purplr));
